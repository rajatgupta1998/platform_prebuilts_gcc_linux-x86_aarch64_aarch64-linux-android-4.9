...
enum opt_code
{
  ...
  OPT_mabi_ = 1068,                          /* -mabi= */
  OPT_march_ = 1069,                         /* -march= */
  OPT_mbig_endian = 1070,                    /* -mbig-endian */
  ...
  OPT_quiet = 1110,                          /* -quiet */
  OPT_r = 1111,                              /* -r */
  OPT_remap = 1112,                          /* -remap */
  OPT_s = 1113,                              /* -s */
  OPT_s_bc_abi = 1114,                       /* -s-bc-abi */
  OPT_save_temps = 1115,                     /* -save-temps */
  OPT_save_temps_ = 1116,                    /* -save-temps= */
  OPT_shared = 1117,                         /* -shared */
  OPT_shared_libgcc = 1118,                  /* -shared-libgcc */
  /* OPT_specs = 1119, */                    /* -specs */
  OPT_specs_ = 1120,                         /* -specs= */
  OPT_static = 1121,                         /* -static */
  OPT_static_libasan = 1122,                 /* -static-libasan */
  OPT_static_libgcc = 1123,                  /* -static-libgcc */
  OPT_static_libgcj = 1124,                  /* -static-libgcj */
  OPT_static_libgfortran = 1125,             /* -static-libgfortran */
  OPT_static_libgo = 1126,                   /* -static-libgo */
  OPT_static_liblsan = 1127,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1128,               /* -static-libstdc++ */
  OPT_static_libtsan = 1129,                 /* -static-libtsan */
  OPT_static_libubsan = 1130,                /* -static-libubsan */
  /* OPT_std_c__03 = 1131, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1132, */                /* -std=c++0x */
  OPT_std_c__11 = 1133,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1134, */                /* -std=c++14 */
  ...
  /* OPT_std_gnu__14 = 1151, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1152,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1153,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1154,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1155, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1156, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1157,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1158,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1159, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1160, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1161,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1162, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1163, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1164, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1165,                     /* -std=legacy */
  OPT_symbolic = 1166,                       /* -symbolic */
  OPT_t = 1167,                              /* -t */
  OPT_time = 1168,                           /* -time */
  OPT_time_ = 1169,                          /* -time= */
