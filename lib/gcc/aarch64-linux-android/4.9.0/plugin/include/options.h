...
enum opt_code
{
  ...
  OPT_fgnu89_inline = 631,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 632,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 633,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 634,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 635,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 636,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 637,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 638,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 639,                       /* -fgraphite */
  OPT_fgraphite_identity = 640,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 641,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 642, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 643, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 644,           /* -fhash-synchronization */
  /* OPT_fhelp = 645, */                     /* -fhelp */
  /* OPT_fhelp_ = 646, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 647,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 648, */                /* -fhonor-std */
  OPT_fhosted = 649,                         /* -fhosted */
  /* OPT_fhuge_objects = 650, */             /* -fhuge-objects */
  OPT_fident = 651,                          /* -fident */
  OPT_fif_conversion = 652,                  /* -fif-conversion */
  OPT_fif_conversion2 = 653,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 654,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 655,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 656,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 657,             /* -fimplicit-templates */
  OPT_findirect_classes = 658,               /* -findirect-classes */
  OPT_findirect_dispatch = 659,              /* -findirect-dispatch */
  OPT_findirect_inlining = 660,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 661,         /* -finhibit-size-directive */
  OPT_finit_character_ = 662,                /* -finit-character= */
  OPT_finit_integer_ = 663,                  /* -finit-integer= */
  OPT_finit_local_zero = 664,                /* -finit-local-zero */
  OPT_finit_logical_ = 665,                  /* -finit-logical= */
  OPT_finit_real_ = 666,                     /* -finit-real= */
  OPT_finline = 667,                         /* -finline */
  OPT_finline_atomics = 668,                 /* -finline-atomics */
  OPT_finline_functions = 669,               /* -finline-functions */
  OPT_finline_functions_called_once = 670,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 671, */            /* -finline-limit- */
  OPT_finline_limit_ = 672,                  /* -finline-limit= */
  OPT_finline_small_functions = 673,         /* -finline-small-functions */
  OPT_finput_charset_ = 674,                 /* -finput-charset= */
  OPT_finstrument_functions = 675,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 676,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 677,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 678,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 679,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 680,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 681,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 682,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 683, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 684,                    /* -fipa-profile */
  ...
  OPT_mcpu_ = 1072,                          /* -mcpu= */
  OPT_mgeneral_regs_only = 1073,             /* -mgeneral-regs-only */
  OPT_mglibc = 1074,                         /* -mglibc */
  ...
  OPT_n = 1082,                              /* -n */
  OPT_no_canonical_prefixes = 1083,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1084,              /* -no-integrated-cpp */
  ...
  OPT_print_multiarch = 1105,                /* -print-multiarch */
  ...
  OPT_static_libasan = 1126,                 /* -static-libasan */
  ...
  OPT_static_liblsan = 1131,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1132,               /* -static-libstdc++ */
  OPT_static_libtsan = 1133,                 /* -static-libtsan */
  OPT_static_libubsan = 1134,                /* -static-libubsan */
