...
enum opt_code
{
  ...
  OPT_fuse_ld_mcld = 995,                    /* -fuse-ld=mcld */
  ...
  /* OPT_fxref = 1024, */                    /* -fxref */
  /* OPT_fzee = 1025, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1026,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1027,                     /* -fzero-link */
  OPT_g = 1028,                              /* -g */
  OPT_gant = 1029,                           /* -gant */
  OPT_gcoff = 1030,                          /* -gcoff */
  OPT_gdwarf = 1031,                         /* -gdwarf */
  OPT_gdwarf_ = 1032,                        /* -gdwarf- */
  OPT_gen_decls = 1033,                      /* -gen-decls */
  OPT_ggdb = 1034,                           /* -ggdb */
  OPT_ggnu_pubnames = 1035,                  /* -ggnu-pubnames */
  OPT_gnat = 1036,                           /* -gnat */
  OPT_gnatO = 1037,                          /* -gnatO */
  OPT_gno_pubnames = 1038,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1039,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1040,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1041,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1042,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1043,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1044,                   /* -gsplit-dwarf */
  OPT_gstabs = 1045,                         /* -gstabs */
  OPT_gstabs_ = 1046,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1047,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1048,                        /* -gtoggle */
  OPT_gvms = 1049,                           /* -gvms */
  OPT_gxcoff = 1050,                         /* -gxcoff */
  OPT_gxcoff_ = 1051,                        /* -gxcoff+ */
  OPT_h = 1052,                              /* -h */
  OPT_idirafter = 1053,                      /* -idirafter */
  OPT_imacros = 1054,                        /* -imacros */
  OPT_imultiarch = 1055,                     /* -imultiarch */
  OPT_imultilib = 1056,                      /* -imultilib */
  OPT_include = 1057,                        /* -include */
  OPT_iplugindir_ = 1058,                    /* -iplugindir= */
  OPT_iprefix = 1059,                        /* -iprefix */
  OPT_iquote = 1060,                         /* -iquote */
  OPT_isysroot = 1061,                       /* -isysroot */
  OPT_isystem = 1062,                        /* -isystem */
  OPT_iwithprefix = 1063,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1064,              /* -iwithprefixbefore */
  OPT_k8 = 1065,                             /* -k8 */
  OPT_l = 1066,                              /* -l */
  OPT_lang_asm = 1067,                       /* -lang-asm */
  OPT_mabi_ = 1068,                          /* -mabi= */
  OPT_mandroid = 1069,                       /* -mandroid */
  OPT_march_ = 1070,                         /* -march= */
  OPT_mbig_endian = 1071,                    /* -mbig-endian */
  OPT_mbionic = 1072,                        /* -mbionic */
  OPT_mcmodel_ = 1073,                       /* -mcmodel= */
  OPT_mcpu_ = 1074,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1075,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1076,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1077,             /* -mgeneral-regs-only */
  OPT_mglibc = 1078,                         /* -mglibc */
  OPT_mlittle_endian = 1079,                 /* -mlittle-endian */
  OPT_mlra = 1080,                           /* -mlra */
  OPT_momit_leaf_frame_pointer = 1081,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1082,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1083,                  /* -mtls-dialect= */
  OPT_mtune_ = 1084,                         /* -mtune= */
  OPT_muclibc = 1085,                        /* -muclibc */
  OPT_n = 1086,                              /* -n */
  ...
  OPT_static_liblsan = 1135,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1136,               /* -static-libstdc++ */
  OPT_static_libtsan = 1137,                 /* -static-libtsan */
  OPT_static_libubsan = 1138,                /* -static-libubsan */
  /* OPT_std_c__03 = 1139, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1140, */                /* -std=c++0x */
  OPT_std_c__11 = 1141,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1142, */                /* -std=c++14 */
  OPT_std_c__1y = 1143,                      /* -std=c++1y */
  OPT_std_c__98 = 1144,                      /* -std=c++98 */
  OPT_std_c11 = 1145,                        /* -std=c11 */
  /* OPT_std_c1x = 1146, */                  /* -std=c1x */
  /* OPT_std_c89 = 1147, */                  /* -std=c89 */
  OPT_std_c90 = 1148,                        /* -std=c90 */
  OPT_std_c99 = 1149,                        /* -std=c99 */
  /* OPT_std_c9x = 1150, */                  /* -std=c9x */
  OPT_std_f2003 = 1151,                      /* -std=f2003 */
  OPT_std_f2008 = 1152,                      /* -std=f2008 */
  OPT_std_f2008ts = 1153,                    /* -std=f2008ts */
  OPT_std_f95 = 1154,                        /* -std=f95 */
  OPT_std_gnu = 1155,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1156, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1157, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1158,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1159, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1160,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1161,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1162,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1163, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1164, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1165,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1166,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1167, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1168, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1169,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1170, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1171, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1172, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1173,                     /* -std=legacy */
  OPT_symbolic = 1174,                       /* -symbolic */
  OPT_t = 1175,                              /* -t */
  OPT_time = 1176,                           /* -time */
  OPT_time_ = 1177,                          /* -time= */
  OPT_tno_android_cc = 1178,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1179,                 /* -tno-android-ld */
  OPT_traditional = 1180,                    /* -traditional */
  OPT_traditional_cpp = 1181,                /* -traditional-cpp */
  OPT_trigraphs = 1182,                      /* -trigraphs */
  OPT_u = 1183,                              /* -u */
  OPT_undef = 1184,                          /* -undef */
  OPT_v = 1185,                              /* -v */
  OPT_version = 1186,                        /* -version */
  OPT_w = 1187,                              /* -w */
  OPT_wrapper = 1188,                        /* -wrapper */
  OPT_x = 1189,                              /* -x */
  OPT_z = 1190,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
